...
public abstract class FarmUpgrades {
	...
	public static void init() {
		new Improvement("farm.fertiliser", farm, "Fertiliser", 30, 1).maintenance(1).yield(3, 0, 0, 0);
		new Improvement("farm.mill", farm, "Mill", 40, 1).maintenance(2).yieldPerWorker(0, 1, 0, 0);
		new Improvement("farm.greenhouse", farm, "Greenhouse", 40, 1).workplaces(1).yieldPerWorker(1, 0, 0, 0);
		new Improvement("farm.market", farm, "Green Market", 60, 1).workplaces(1).yield(1, 0, 1, 0).yieldPerWorker(0, 0, 1, 0);
		
		new Improvement("farm.granary", farm, "Granary", 60, 1).cityUnique().maintenance(1).bonusResources(1)
		...
		new Improvement("farm.distillery", farm, "Distillery", 80, 2).cityUnique().workplaces(1).maintenance(2).yield(0, 2, 0, 0)
