...
public class ClickButton extends UIHoverElement {
	...
	public ClickButton(UIContainer parent, String label, int w, int h, Font font) {
		super(parent);
		this.font = font;
		this.label = label;
		setSize(w, h);
	...
	public ClickButton(UIContainer parent, String label, int w) {
		this(parent, label, w, defaultHeight, Res.font);
	}

	public ClickButton setFrameSize(int w, int h) {
		this.frameWidth = w;
		this.frameHeight = h;
		return this;
	}
